...
public class TimeZoneTranslator {
	...
	protected static DateTime shiftTimeZone(DateTime inputDate, int fromOffset, int toOffset) {
	...
	protected static Event shiftEventTimeZone(Event inputEvent, TimeZone fromZone, TimeZone toZone) {
